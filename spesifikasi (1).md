...
- **Tujuan Belajar** : Peserta didik mampu memahami konsep, membaca, menuliskan, dan menentukan posisi bilangan bulat pada garis bilangan dengan benar
- **Nama Guru**      : Luluk Ianatul Afifah, S.Pd
- **Nama Sekolah**   :  SMP Negeri 5 Lamongan
- **File Logo**      : logo.jfif
- **File Foto Guru** : guru,jfif
- **File Background**: bg.jfif
